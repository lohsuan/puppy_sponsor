    ...
    <div className="min-h-screen">
      <div className="m-auto p-5 max-w-[90vw] xl:max-w-[70vw] md:w-auto rounded-lg border shadow-md border-gray-700 bg-gray-800">
        ...
        <div className="flex flex-col items-center md:flex-row">
          <img
            className="my-2 cursor-pointer opacity-20 p-5 border-dashed border-4 border-gray-400 hover:border-amber-300 max-h-40 md:max-h-max md:h-auto object-cover w-auto rounded-t-lg md:w-1/3 md:rounded-none md:rounded-l-lg"
            src="https://i.imgur.com/yk9WRbT.webp"
            alt=""
          />
